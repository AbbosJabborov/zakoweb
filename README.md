...
See [`deployment/DEPLOYMENT_GUIDE.md`](deployment/DEPLOYMENT_GUIDE.md) for full instructions on:
- Containerizing with `docker compose up -d`
- Setting up Nginx Proxy Manager with WebSocket `/ws/` upgrades & SSL
